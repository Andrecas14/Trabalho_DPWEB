...
<body>
    ...
    <main>
      <section id="galeria" class="content">
        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/campismo.png"  width="600" height="500">
            <div class="desc">A entrada para o nosso parque</div>
          </div>
        </div>
    
        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/pesca.jpg"  width="600" height="400">
            <div class="desc">Pescaria local</div>
          </div>
        </div>
    
        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/imagem5.jpg"  width="600" height="400">
            <div class="desc">A nossa praia da tocha</div>
          </div>
        </div>
    
        <div class="responsive imagem">
          <div class="gallery">   
              <img src="imagens/praia2.jpg"  width="600" height="400">
            <div class="desc">O famoso baloiço da nossa praia</div>
          </div>
        </div>

        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/uau.png"  width="600" height="500">
            <div class="desc">Foto tirada por um colaborador</div>
          </div>
        </div>

        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/mobiles.jpg"  width="600" height="500">
            <div class="desc">As nossas mobile homes</div>
          </div>
        </div>

        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/b.jpg"  width="600" height="500">
            <div class="desc">Foto tirada por um colaborador</div>
          </div>
        </div>
        ...
        <div class="responsive imagem">
          <div class="gallery">
              <img src="imagens/parque.png"  width="600" height="500">
            <div class="desc">Mapa do parque</div>
          </div>
        </div>
          <div>
